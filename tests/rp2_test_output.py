  ...
  entries=
    GainLoss:
      ...
      taxable_event=InTransaction:
        ...
        from_lot=
        to_lots=
        cost_basis_timestamp=2020-02-01 11:18:00.000000 +0000
    ...
    GainLoss:
      ...
      taxable_event=InTransaction:
        ...
        from_lot=
        to_lots=
        cost_basis_timestamp=2020-03-01 09:45:00.000000 +0000
      acquired_lot_fiat_amount_with_fee_fraction=0.0000
      acquired_lot_fraction_percentage=0.0000%
      acquired_lot=None
      taxable_event_fraction=1 of 1
  ...
  entries=
    GainLoss:
      ...
      acquired_lot=InTransaction:
        ...
        from_lot=
        to_lots=
        cost_basis_timestamp=2020-01-01 08:41:00.000000 +0000
      taxable_event_fraction=1 of 1
    ...
    GainLoss:
      ...
      acquired_lot=InTransaction:
        ...
        from_lot=
        to_lots=
        cost_basis_timestamp=2020-04-01 09:45:00.000000 +0000
    ...
    GainLoss:
      ...
      acquired_lot=InTransaction:
        ...
        from_lot=
        to_lots=
        cost_basis_timestamp=2020-05-01 14:03:00.000000 +0000
      taxable_event_fraction=2 of 2
      acquired_lot_fraction=1 of 1
      parent=14->6""",
    "B3": """GainLossSet:
