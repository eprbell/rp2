...
RP2_TEST_OUTPUT = {
  ...
  entries=
    GainLoss:
      ...
      disposed_of_lot_fiat_amount_with_fee_fraction=2220.0000
      disposed_of_lot_fraction_percentage=20.0000%
      ...
      taxable_event_fraction=1 of 1
      disposed_of_lot_fraction=1 of 2
      parent=None
    GainLoss:
      id=2->None
      crypto_amount=2.00000000
    ...
    GainLoss:
      ...
      disposed_of_lot_fiat_amount_with_fee_fraction=8880.0000
      disposed_of_lot_fraction_percentage=80.0000%
      disposed_of_lot=InTransaction:
        id=3
        timestamp=2020-01-01 08:41:00.000000 +0000
        asset=B2
      ...
      disposed_of_lot_fraction=2 of 2
      parent=2->None
    GainLoss:
      id=14->2
      crypto_amount=0.20000000
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=12200.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=2400.0000
      disposed_of_lot_fraction_percentage=10.0000%
      disposed_of_lot=InTransaction:
        id=2
        timestamp=2020-02-01 11:18:00.000000 +0000
        asset=B2
    ...
    GainLoss:
      ...
      disposed_of_lot_fiat_amount_with_fee_fraction=21600.0000
      disposed_of_lot_fraction_percentage=90.0000%
      disposed_of_lot=InTransaction:
        id=2
        timestamp=2020-02-01 11:18:00.000000 +0000
        asset=B2
    ...
    GainLoss:
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=71000.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=39000.0000
      disposed_of_lot_fraction_percentage=100.0000%
      disposed_of_lot=InTransaction:
        id=6
        timestamp=2020-03-01 09:45:00.000000 +0000
        asset=B2
      ...
      disposed_of_lot_fraction=1 of 1
      parent=16->2
    GainLoss:
      id=16->5
      crypto_amount=0.20000000
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=71000.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=2820.0000
      disposed_of_lot_fraction_percentage=5.0000%
      disposed_of_lot=InTransaction:
        id=5
      ...
      disposed_of_lot_fraction=1 of 3
      parent=16->6
    GainLoss:
      id=12->5
      ...
      disposed_of_lot_fiat_amount_with_fee_fraction=53439.0000
      disposed_of_lot_fraction_percentage=94.7500%
      disposed_of_lot=InTransaction:
        id=5
        timestamp=2020-04-01 09:45:00.000000 +0000
        asset=B2
        ...
        fiat_taxable_amount=0.0000
      taxable_event_fraction=1 of 1
      disposed_of_lot_fraction=2 of 3
      parent=16->5
    GainLoss:
      id=13->5
      ...
      taxable_event_fiat_amount_with_fee_fraction=202.0000
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=40602.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=141.0000
      disposed_of_lot_fraction_percentage=0.2500%
      disposed_of_lot=InTransaction:
        id=5
        timestamp=2020-04-01 09:45:00.000000 +0000
        asset=B2
        ...
        fiat_taxable_amount=0.0000
      taxable_event_fraction=1 of 2
      disposed_of_lot_fraction=3 of 3
      parent=12->5
    GainLoss:
      id=13->4
      crypto_amount=2.00000000
      fiat_cost_basis=30200.0000
      fiat_gain=10200.0000
      is_long_term_capital_gains=True
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=40602.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=30200.0000
      disposed_of_lot_fraction_percentage=40.0000%
      disposed_of_lot=InTransaction:
        id=4
  ...
  entries=
    GainLoss:
      ...
      disposed_of_lot_fiat_amount_with_fee_fraction=111.0000
      disposed_of_lot_fraction_percentage=1.0000%
      disposed_of_lot=InTransaction:
        id=3
        timestamp=2020-01-01 08:41:00.000000 +0000
        asset=B3
    ...
    GainLoss:
      ...
      disposed_of_lot_fiat_amount_with_fee_fraction=222.0000
      disposed_of_lot_fraction_percentage=2.0000%
      disposed_of_lot=InTransaction:
        id=3
        timestamp=2020-01-01 08:41:00.000000 +0000
        asset=B3
    ...
    GainLoss:
      ...
      disposed_of_lot_fiat_amount_with_fee_fraction=444.0000
      disposed_of_lot_fraction_percentage=4.0000%
      disposed_of_lot=InTransaction:
        id=3
        timestamp=2020-01-01 08:41:00.000000 +0000
        asset=B3
  ...
  entries=
    ...
    GainLoss:
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=12200.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=8769.0000
      disposed_of_lot_fraction_percentage=79.0000%
      disposed_of_lot=InTransaction:
        id=3
        timestamp=2020-01-01 08:41:00.000000 +0000
        asset=B4
    ...
    GainLoss:
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=12200.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=2520.0000
      disposed_of_lot_fraction_percentage=10.5000%
      disposed_of_lot=InTransaction:
        id=2
        timestamp=2020-02-01 11:18:00.000000 +0000
        asset=B4
    ...
    GainLoss:
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=71000.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=21480.0000
      disposed_of_lot_fraction_percentage=89.5000%
      disposed_of_lot=InTransaction:
        id=2
        timestamp=2020-02-01 11:18:00.000000 +0000
        asset=B4
    ...
    GainLoss:
      ...
      taxable_event=OutTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=71000.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=2961.0000
      disposed_of_lot_fraction_percentage=5.2500%
      disposed_of_lot=InTransaction:
        id=5
        timestamp=2020-04-01 09:45:00.000000 +0000
        asset=B4
    ...
    GainLoss:
      ...
      taxable_event=IntraTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=288.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=302.0000
      disposed_of_lot_fraction_percentage=0.4000%
      disposed_of_lot=InTransaction:
        id=4
        timestamp=2020-05-01 14:03:00.000000 +0000
        asset=B4
    ...
    GainLoss:
      ...
      fiat_gain=10251.0000
      is_long_term_capital_gains=True
      taxable_event_fiat_amount_with_fee_fraction=40602.0000
      taxable_event_fraction_percentage=100.0000%
      taxable_event=OutTransaction:
        id=13
        timestamp=2021-06-11 05:31:00.000000 +0000
        ...
        is_taxable=True
        fiat_taxable_amount=40602.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=30351.0000
      disposed_of_lot_fraction_percentage=40.2000%
      disposed_of_lot=InTransaction:
        id=4
        timestamp=2020-05-01 14:03:00.000000 +0000
        asset=B4
    ...
    GainLoss:
      ...
      taxable_event=IntraTransaction:
        ...
        is_taxable=True
        fiat_taxable_amount=856.0000
      disposed_of_lot_fiat_amount_with_fee_fraction=604.0000
      disposed_of_lot_fraction_percentage=0.8000%
      disposed_of_lot=InTransaction:
        id=4
        timestamp=2020-05-01 14:03:00.000000 +0000
        asset=B4
