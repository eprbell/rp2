...
- it manages all the complexity related to coin flows and tax calculation and it generates forms that tax accountants can understand (even if they are not cryptocurrency experts);
