...
RP2 supports multiple [countries and accounting methods](https://github.com/eprbell/rp2/blob/main/docs/supported_countries.md): supported accounting methods vary country by country.
...
## Supported Countries
Read the [supported countries](https://github.com/eprbell/rp2/blob/main/docs/supported_countries.md)
